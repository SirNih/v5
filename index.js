...
LexxyOFC.sendMessage(from, result, audio, { mimetype: 'audio/mp4', duration: 359996400, ptt: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true}})}
    ...
    const ownerNumber = [`6288279268363@s.whatsapp.net`]
...
LexxyOFC.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      LexxyOFC.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = LexxyOFC.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6283871990243-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/HAZ6yFgCafUAeDbNH33IrL', "groupName": `Bear-Bot Inc.`, "footerText": "*_© Bear Botz_*", "jpgThumbnail": fake.jpg, "caption": teks}}, {quoted:mek})
...
const fakeitem = (teks) => {
        ...
        participant:`0@s.whatsapp.net`, ...(from ? {
remoteJid :"6283871990243-1604595598@g.us" }: {})
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./media/gambar/fake.jpg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":`Bear Botz`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})}
const katalog = (teks) => {
             res = LexxyOFC.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*Bear Botz*", "thumbnail": tb, "surface": 'CATALOG' }}, {quoted:mek})
...
"externalAdReply": {
                "title": `${namabot}`,
                "body": "𝑩𝒚 King Of Bear 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍",
                "previewType": "PHOTO",
                "thumbnailUrl": "https://i.ibb.co/nDPHGBQ/gambar1.jpg",
                "thumbnail": fake,
                "sourceUrl": `https://www.youtube.com/channel/UCu3cFVCT9rHD1spardoP93g`
...
"externalAdReply": {
                ...
                "body": `𝑩𝒚 King Of Bear 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍`,
                "mediaType": "10",
                "mediaUrl": `https://www.youtube.com/channel/UCu3cFVCT9rHD1spardoP93g`,
                "thumbnailUrl": "https://i.ibb.co/nDPHGBQ/gambar1.jpg",
                "thumbnail": tb,
                "sourceUrl": `https://www.youtube.com/channel/UCu3cFVCT9rHD1spardoP93g`,
...
buttonsMessage = { contentText: `${ruls}`, footerText: '© King Of Bear 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍\n*Semangat Belajarnya!*', buttons: buttons, headerType: 1 }
prep = await LexxyOFC.prepareMessageFromContent(from,{buttonsMessage},{quoted: fgif})
LexxyOFC.relayWAMessage(prep)
break
       // Set Profile Group
...
sendMediaURL(from, anu.result.result, `Nih Kak Hasilnya ^_^`)
       break
case 'love':        
            if (args.length == 0) return reply(`contoh: ${prefix + command} Bear Botz`)
            reply(mess.wait)
            bo = args.join(" ")
...
© 𝑪𝒓𝒆𝒂𝒕𝒆𝒅 𝒃𝒚 King Of Bear 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍`
             replyfakelink(teks)
             break;
      case "totag":
        if (
...
${
 ...
 footerText: '© King Of Bear 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍',
